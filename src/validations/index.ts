...
export const CountrySchema = z.enum([countries.countries[0].name, ...countries.countries.slice(1).map((country) => country.name)], {
    message: "The country you enter is not recognized, please enter one of the available countries",
});