...
const postgresUriRegex = /^postgres(?:ql)?:\/\/(?:[^:@]+(?::[^:@]*)?@)?[^#/:?]+(?::\d+)?(?:\/[^#?]*)?(?:\?[^#]*)?(?:#.*)?$/;
...
export const envSchema: z.ZodObject<{
    ...
    SERVER_API_URL: z.ZodEffects<z.ZodEffects<z.ZodString, string, string>, string, string>;
    PORT: z.ZodEffects<z.ZodDefault<z.ZodNumber>, number, unknown>;
    JWT_SECRET: z.ZodString;
    JWT_ACCESS_EXPIRATION_MINUTES: z.ZodEffects<z.ZodDefault<z.ZodNumber>, number, unknown>;
    JWT_REFRESH_EXPIRATION_DAYS: z.ZodEffects<z.ZodDefault<z.ZodNumber>, number, unknown>;
    JWT_RESET_PASSWORD_EXPIRATION_MINUTES: z.ZodEffects<z.ZodDefault<z.ZodNumber>, number, unknown>;
    JWT_VERIFY_EMAIL_EXPIRATION_MINUTES: z.ZodEffects<z.ZodDefault<z.ZodNumber>, number, unknown>;
